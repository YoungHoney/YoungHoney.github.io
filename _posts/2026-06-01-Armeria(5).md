...
**[ikhoon 리뷰어가 $defs 구조로 변경을 요청한 코드리뷰 댓글 스크린샷을 첨부해주세요. PR #6370의 리뷰 댓글입니다.]**
...
**[구현 이후 DocService에서 Animal 타입이 oneOf와 discriminator 정보와 함께 표시되는 스크린샷을 첨부해주세요. PR merge 이후 상태입니다.]**
